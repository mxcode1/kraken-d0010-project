...
def index(request):
    ...
    <head>
        ...
        <style>
            ...
            .stats {{ background: #e9ecef; padding: 20px; border-radius: 8px; margin-bottom: 30px; }}
            .stat {{ margin: 15px 0; display: flex; justify-content: space-between; align-items: center; }}
            .stat-label {{ font-weight: bold; }}
            .stat-value {{ background: #007bff; color: white; padding: 5px 15px; border-radius: 20px; }}
            ...
            .kraken {{ font-size: 3em; text-align: center; margin: 20px 0; }}
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <div class="usage">
                ...
                <ol>
                    <li><strong>Import D0010 files:</strong> <span class="code">python manage.py import_d0010 path/to/file.uff</span></li>
                    <li><strong>Browse data:</strong> Use the <a href="/admin/">Admin Interface</a> above</li>
                    <li><strong>Search by MPAN:</strong> Enter 13-digit meter point number</li>
                    <li><strong>Search by Serial:</strong> Enter meter serial number</li>
                    <li><strong>View source files:</strong> See which file each reading came from</li>
                </ol>

                <h3>🔍 Demo Search Examples</h3>
                <ul>
                    <li><strong>MPAN Search:</strong> Try searching for <span class="code">1200023305967</span></li>
                    <li><strong>Serial Search:</strong> Try searching for <span class="code">F75A 00802</span></li>
                    <li><strong>Filename Search:</strong> Try searching for <span class="code">sample_d0010.uff</span></li>
                </ul>
            </div>
        </div>
    </body>
